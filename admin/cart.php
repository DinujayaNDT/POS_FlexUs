        ...
        <div class="span12">
          <form method="post" class="form-horizontal" name="submit">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea class="span11" id="customeraddress" name="customeraddress" required='true'></textarea>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls payment-methods">
                <div class="payment-method">
                  <input type="radio" id="cash" name="modepayment" value="Cash" checked="true">
            ...
            <div class="control-group additional-methods" id="additionalMethods">
              <div class="controls payment-methods">
                <div class="payment-method">
